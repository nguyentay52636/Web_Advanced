    ...
    <div class="spacing">
        <div class="container text-dark text-center">
            ...
            <div class="btn-phantrang d-lg-flex justify-content-center m-5">
                <button class="btn">Cafe</button>
                <button class="btn">loại 1</button>
                <button class="btn">Loại 2</button>
                <button class="btn">Khác</button>
            </div>
                ...
                <div
                    ...
                    <div class="card">
                        <div class="card__image">
                            <img
                                src="https://barista.qodeinteractive.com/elementor/wp-content/uploads/2016/03/product-image-1-500x500.jpg"
                                alt="image" />
            ...
            <div class="pagination-div">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <!-- Page Numbers -->
                        <li class="btn-previous active"><a class="page-link" href="#">1</a></li>
